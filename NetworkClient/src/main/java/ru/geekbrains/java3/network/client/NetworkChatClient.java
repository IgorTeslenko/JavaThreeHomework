package ru.geekbrains.java3.network.client;
...
import ru.geekbrains.java3.network.client.controllers.AuthDialogController;
import ru.geekbrains.java3.network.client.controllers.ViewController;
